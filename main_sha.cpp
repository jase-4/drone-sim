...
int main()
{
    ...
    // load textures
    // -------------
    unsigned int woodTexture = loadTexture("obj/rock.jpg");
    ...
    while (!glfwWindowShouldClose(window))
    {
      ...
      float currentFrame = static_cast<float>(glfwGetTime());
        ...
        lightPos.z = static_cast<float>(sin(glfwGetTime() * 0.5) * 7.0);
...
void renderScene(const Shader &shader)
{
    ...
    model = glm::scale(model, glm::vec3(105.0f,0.05f,105.0f));
